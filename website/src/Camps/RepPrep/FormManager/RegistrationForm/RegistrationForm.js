...
export default function RegistrationForm({ ageGroup, onSubmit, onBack, onClose }) {
    ...
    return (
        <div>
            {isMobile ? <MobileRegistrationForm ageGroup={ageGroup} onSubmit={onSubmit} onBack={onBack} onClose={onClose}/> : 
                        <DesktopRegistrationForm ageGroup={ageGroup} onSubmit={onSubmit} onBack={onBack} onClose={onClose}/>}
        </div>
    );
}

function DesktopRegistrationForm({ ageGroup, onSubmit, onBack, onClose }) {
...
function MobileRegistrationForm({ ageGroup, onSubmit, onBack, onClose }) {
    ...
    return (
        <div className="registration-form-container-mobile">
            <div className="registration-form-mobile">
                <TiDeleteOutline className="close-button-mobile" onClick={onClose} />
                <TiArrowLeftOutline className="back-button-mobile" onClick={onBack} />
                <h2 className="form-title">{ageGroup} Camp Registration </h2>
                <form onSubmit={handleSubmit}>
                
                    <div className="form-group-mobile">
                        <div className="label-container-form-mobile">
                            <label className="input-label-mobile">Players Name:</label>
                        </div>
                        <div className="input-container-form-mobile">
                            <input className="input-field-mobile" type="text" name="name" onChange={e => setName(e.target.value)}required />
                        </div>
                    </div>
                    
                    { ageGroup === "U11" ? (
                        <>
                            <div className="r-radio-buttons-mobile">
                                <label className="input-label-mobile">Birth Year</label>
                            ...
                            <div className="r-radio-buttons-mobile">
                                <label className="input-label-mobile">2022-2023 Winter Team</label>
                                <div className="radio-container-mobile">
                                    <input type="radio" id="H4" name="hockeylevel" value="H4" checked={winterTeam === "H4"} onChange={e => setWinterTeam(e.target.value)}/><label htmlFor="H4">Hockey 4</label>
                                    <input type="radio" id="AtomC" name="hockeylevel" value="AtomC" checked={winterTeam === "AtomC"} onChange={e => setWinterTeam(e.target.value)}/><label htmlFor="AtomC">Atom C</label>
                                    <input type="radio" id="AtomA3" name="hockeylevel" value="AtomA3" checked={winterTeam === "AtomA3"} onChange={e => setWinterTeam(e.target.value)}/><label htmlFor="AtomA3">Atom A3</label>
                    ...
                    <div className="r-radio-buttons-mobile">
                        <label className="input-label-mobile">Position</label>
                        <div className="radio-container-mobile">
                            <input type="radio" id="G" name="position" value="G" checked={position === "G"} onChange={e => setPosition(e.target.value)}/><label htmlFor="G">Goalie</label>
                            <input type="radio" id="F" name="position" value="F" checked={position === "F"} onChange={e => setPosition(e.target.value)}/><label htmlFor="F">Forward</label>
                            <input type="radio" id="D" name="position" value="D" checked={position === "D"} onChange={e => setPosition(e.target.value)}/><label htmlFor="D">Defence</label>
                    ...
                    <div className="form-group-mobile">
                        <div className="label-container-form-mobile">
                            <label className="input-label-mobile">Parents Name:</label>
                        </div>
                        <div className="input-container-form-mobile">
                            <input className="input-field-mobile" type="text" name="name" onChange={e => setParentName(e.target.value)} required />
                        </div>
                    </div>
                    ...
                    <div className="form-group-mobile">
                        ...
                        <div className="input-container-form-mobile">
                            <input className="input-field-mobile" type="text" name="email" onChange={e => setEmail(e.target.value)} required />
                        </div>
                    </div>
                    ...
                    <div className="form-group-mobile">
                        ...
                        <div className="input-container-form-mobile">
                            <input className="input-field-mobile" type="text" name="phoneNumber" onChange={e => setPhoneNumber(e.target.value)} required />
                        </div>
                    </div>

                    <div className="submit-button-container-mobile">
                        <button type="submit" className="submit-button-mobile">Submit</button>
                    </div>
                </form>
            </div>
        </div>
